...
//In summary, the PathOperationsTest class demonstrates the following path operations:
//
//Normalize: Removes redundant components and resolves relative paths.
//Subpath: Extracts a subpath from a given path.
//Resolve: Combines two paths, resolving relative paths against a base path.
//Relativize: Calculates the relative path between two paths.
//This class provides examples of how to use the Path class to manipulate file and directory paths in a more structured and
// robust way compared to using strings directly.
