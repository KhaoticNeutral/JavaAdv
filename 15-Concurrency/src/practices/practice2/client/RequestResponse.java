...
// the RequestResponse class encapsulates the information about a network request and its response.
// The equals() and hashCode() methods are implemented to ensure proper object comparison and hashing, which is essential for
// using RequestResponse objects as keys in maps or other data structures.