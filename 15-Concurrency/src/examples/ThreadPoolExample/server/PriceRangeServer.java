...
//the PriceRangeServer class implements a simple network server that listens for connections, generates a random price,
// and sends it to the client. It uses a timeout to periodically check if the thread has been interrupted, and it handles exceptions gracefully.