...
//The Buyer class represents a buyer with a name and a BuyerClass. It uses the Singleton pattern to ensure that only one
// instance of the class can be created. The getBuyerMap method provides a convenient way to access a predefined list of buyers.
// This class is likely used in a larger application where buyers are involved in transactions or other business logic.
