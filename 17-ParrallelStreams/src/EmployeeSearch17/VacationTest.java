...
//this code demonstrates how to use Java streams and enums to calculate and display vacation days and bonuses for
// employees based on their roles and salary. It utilizes the LocalDate class for date calculations and the VacAccrual
// and Bonus enums to define the accrual rates and bonus percentages for different roles.
