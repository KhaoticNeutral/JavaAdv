...
public class LocalDatesAndTimes1 {
    ...
    public static void main(String[] args) {
        ...
        int excludeWeeks = 5;
        LocalDate schoolStarts = LocalDate.of(2024, JANUARY, 14).with(TemporalAdjusters.firstInMonth(TUESDAY)).with(TemporalAdjusters.next(TUESDAY));
        ...
        LocalDate schoolEnds = LocalDate.of(2024, DECEMBER, 10);
